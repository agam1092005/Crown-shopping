...
import 'otherbrand_listview_page.dart';
import 'otherbrand_model.dart';
import 'otherbrand_details_page.dart';
import 'package:flutter/material.dart';

class OtherGridPage extends StatefulWidget {
  @override
  _OtherGridPageState createState() => _OtherGridPageState();
}

class _OtherGridPageState extends State<OtherGridPage> {
  List<OtherModel> otherList = OtherModel.list;
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return OtherDetailPage(otherList[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 100,
                                    child: Hero(
                                      tag: "hero${otherList[index].imgPath}",
                                      child: Image(
                                        image: AssetImage(
                                            "images/${otherList[index].imgPath}"),
                                      ),
                                    ),
                                  ),
                                ],
