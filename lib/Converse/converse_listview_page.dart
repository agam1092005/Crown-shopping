...
import 'converse_gridview_page.dart';
import 'converse_model.dart';
import 'package:flutter/material.dart';

class ConverseListPage extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<ConverseListPage> {
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      PageRouteBuilder(
                        ...
                        pageBuilder: (context, animation, animationTime) {
                          return ConverseDetailPage(data);
                        },
                      ),
                    );
                  },
