...
import 'mens_details_page.dart';
import 'mens_listview_page.dart';
import 'mens_model.dart';
import 'package:flutter/material.dart';

class MenGridPage extends StatefulWidget {
  @override
  _MenGridPageState createState() => _MenGridPageState();
}

class _MenGridPageState extends State<MenGridPage> {
  List<MenModel> menList = MenModel.list;
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return MenDetailPage(menList[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 1,
                                    child: Hero(
                                      tag: "hero${menList[index].imgPath}",
                                      child: Image(
                                        image: AssetImage(
                                            "images/${menList[index].imgPath}"),
                                      ),
                                    ),
                                  ),
                                ],
