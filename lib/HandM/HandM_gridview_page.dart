...
import 'HandM_details_page.dart';
import 'HandM_listview_page.dart';
import 'package:flutter/material.dart';

class HandMGridPage extends StatefulWidget {
  @override
  _HandMGridPageState createState() => _HandMGridPageState();
}

class _HandMGridPageState extends State<HandMGridPage> {
  List<HandMModel> handmList = HandMModel.list;
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return HandMDetailPage(handmList[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 30,
                                    child: Hero(
                                      tag: "hero${handmList[index].imgPath}",
                                      child: Image(
                                        image: AssetImage(
                                            "images/${handmList[index].imgPath}"),
                                      ),
                                    ),
                                  ),
                                ],
