...
class _DetailPageState extends State<ShoeDetailPage> {
  @override
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () async {
              ...
              prefs.setString('productname', widget.shoeModel.name);
              prefs.setString('productimage', widget.shoeModel.imgPath.toString());
              prefs.setDouble('productprice', widget.shoeModel.price);
              Navigator.push(
                context,
                PageRouteBuilder(
                  transitionsBuilder:
