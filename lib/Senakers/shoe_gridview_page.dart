...
class ShoeGridPage extends StatefulWidget {
  @override
  _ShoeGridPageState createState() => _ShoeGridPageState();
}

class _ShoeGridPageState extends State<ShoeGridPage> {
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return ShoeDetailPage(shoeList[index]);
                              },
                            ),
                          );
                        },
