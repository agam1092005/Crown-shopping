...
class AdidasDetailPage extends StatefulWidget {
  ...
  AdidasDetailPage(this.adidasModel);

  @override
  _DetailPageState createState() => _DetailPageState();
}

class _DetailPageState extends State<AdidasDetailPage> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        backgroundColor: widget.adidasModel.color,
        appBar: AppBar(
          backgroundColor: widget.adidasModel.color,
          elevation: 0,
          title: Text(
          ...
          child: Stack(
            children: <Widget>[
              ...
              Padding(
                ...
                child: Hero(
                  tag: "hero${widget.adidasModel.imgPath}",
                  child: Transform.rotate(
                    ...
                    child: Padding(
                      ...
                      child: Image(
                        ...
                        image: AssetImage("images/${widget.adidasModel.imgPath}"),
                      ),
                    ),
                  ),
                ),
