...
import 'flying_machine_gridview_page.dart';
import 'flying_machine_model.dart';
import 'package:flutter/material.dart';

class FlyingMachineListPage extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<FlyingMachineListPage> {
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      PageRouteBuilder(
                        ...
                        pageBuilder: (context, animation, animationTime) {
                          return FlyingMachineDetailPage(data);
                        },
                      ),
                    );
                  },
