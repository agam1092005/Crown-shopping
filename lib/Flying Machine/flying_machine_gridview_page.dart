...
import 'flying_machine_listview_page.dart';
import 'flying_machine_model.dart';
import 'flying_machine_details_page.dart';
import 'package:flutter/material.dart';

class FlyingMachineGridPage extends StatefulWidget {
  @override
  _FlyingMachineGridPageState createState() => _FlyingMachineGridPageState();
}

class _FlyingMachineGridPageState extends State<FlyingMachineGridPage> {
  List<FlyingMachineModel> flyingmachineList = FlyingMachineModel.list;
              ...
              children: [
                Container(
                  ...
                  child: ListView.builder(
                    itemCount: flyingmachineList.length,
                    scrollDirection: Axis.vertical,
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return FlyingMachineDetailPage(flyingmachineList[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 30,
                                    child: Hero(
                                      tag: "hero${flyingmachineList[index].imgPath}",
                                      child: Image(
                                        image: AssetImage(
                                            "images/${flyingmachineList[index].imgPath}"),
                                      ),
                                    ),
                                  ),
                                ],
...
Widget _buildBackground(int index, double width) {
  ...
  return ClipPath(
    ...
    child: Container(
      color: flyingmachineList[index].color,
      width: width,
      child: Stack(
        children: <Widget>[
          Padding(
