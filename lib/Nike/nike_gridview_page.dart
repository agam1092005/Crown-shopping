...
import 'nike_details_page.dart';
import 'nike_listview_page.dart';
import 'package:flutter/material.dart';
import 'dart:math' as math;

class NikeGridPage extends StatefulWidget {
  @override
  _NikeGridPageState createState() => _NikeGridPageState();
}

class _NikeGridPageState extends State<NikeGridPage> {
  List<NikeModel> nikeList = NikeModel.list;
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return NikeDetailPage(nikeList[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 1,
                                    child: Hero(
                                      tag: "hero${nikeList[index].imgPath}",
                                      child: Transform.rotate(
                                        angle: -math.pi / 7,
                                        child: Image(
                                          width: 300,
                                          image: AssetImage(
                                              "images/${nikeList[index].imgPath}"),
                                        ),
                                      ),
                                    ),
                                  ),
