...
class FBHomePage extends StatefulWidget {
  static const String id = 'FB_Home_Page';

  @override
  _FBHomePageState createState() => _FBHomePageState();
}

class _FBHomePageState extends State<FBHomePage> with TickerProviderStateMixin {
  List<Widget> _pages = [
    Home(),
    CategoryPage(),
    ShoppingCart(),
