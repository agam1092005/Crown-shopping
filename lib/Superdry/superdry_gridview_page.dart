...
import 'superdry_details_page.dart';
import 'superdry_listview_page.dart';
import 'superdry_model.dart';
import 'package:flutter/material.dart';

class SuperdryGridPage extends StatefulWidget {
  @override
  _SuperdryGridPageState createState() => _SuperdryGridPageState();
}

class _SuperdryGridPageState extends State<SuperdryGridPage> {
  List<SuperdryModel> superdryList = SuperdryModel.list;
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return SuperdryDetailPage(superdryList[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 30,
                                    child: Hero(
                                      tag: "hero${superdryList[index].imgPath}",
                                      child: Image(
                                        image: AssetImage(
                                            "images/${superdryList[index].imgPath}"),
                                      ),
                                    ),
                                  ),
                                ],
...
Widget _buildBackground(int index, double width) {
  ...
  return ClipPath(
    ...
    child: Container(
      color: superdryList[index].color,
      width: width,
      child: Stack(
        children: <Widget>[
          Padding(
