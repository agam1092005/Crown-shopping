...
import 'superdry_gridview_page.dart';
import 'superdry_model.dart';
import 'package:flutter/material.dart';

class SuperdryListPage extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<SuperdryListPage> {
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      PageRouteBuilder(
                        ...
                        pageBuilder: (context, animation, animationTime) {
                          return SuperdryDetailPage(data);
                        },
                      ),
                    );
                  },
