...
import 'timberland_gridview_page.dart';
import 'timberland_model.dart';
import 'package:flutter/material.dart';

class TimberlandListPage extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<TimberlandListPage> {
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      PageRouteBuilder(
                        ...
                        pageBuilder: (context, animation, animationTime) {
                          return TimberlandDetailPage(data);
                        },
                      ),
                    );
                  },
