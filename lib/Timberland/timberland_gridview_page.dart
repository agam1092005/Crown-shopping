...
import 'timberland_details_page.dart';
import 'timberland_listview_page.dart';
import 'package:flutter/material.dart';
import 'dart:math' as math;

class TimberlandGridPage extends StatefulWidget {
  @override
  _TimberlandGridPageState createState() => _TimberlandGridPageState();
}

class _TimberlandGridPageState extends State<TimberlandGridPage> {
  List<TimberlandModel> timberlandList = TimberlandModel.list;
              ...
              children: [
                Container(
                  ...
                  child: ListView.builder(
                    itemCount: timberlandList.length,
                    scrollDirection: Axis.vertical,
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return TimberlandDetailPage(timberlandList[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 1,
                                    child: Hero(
                                      tag: "hero${timberlandList[index].imgPath}",
                                      child: Transform.rotate(
                                        angle: -math.pi / 7,
                                        child: Image(
                                          width: 300,
                                          image: AssetImage(
                                              "images/${timberlandList[index].imgPath}"),
                                        ),
                                      ),
                                    ),
                                  ),
...
Widget _buildBackground(int index, double width) {
  ...
  return ClipPath(
    ...
    child: Container(
      color: timberlandList[index].color,
      width: width,
      child: Stack(
        children: <Widget>[
          Padding(
