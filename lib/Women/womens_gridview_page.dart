...
class WomenGridPage extends StatefulWidget {
  @override
  _WomenGridPageState createState() => _WomenGridPageState();
}
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return WomenDetailPage(womenList[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 100,
                                    child: Hero(
                                      tag: "hero${womenList[index].imgPath}",
                                      child: Image(
                                        image: AssetImage(
                                            "images/${womenList[index].imgPath}"),
                                      ),
                                    ),
                                  ),
                                ],
