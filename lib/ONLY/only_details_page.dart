        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () async {
              ...
              prefs.setString('productname', widget.onlyModel.name);
              prefs.setString('productimage', widget.onlyModel.imgPath.toString());
              prefs.setDouble('productprice', widget.onlyModel.price);
              Navigator.push(
                context,
                PageRouteBuilder(
                  transitionsBuilder:
