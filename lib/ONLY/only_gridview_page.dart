...
import 'only_details_page.dart';
import 'only_listview_page.dart';
import 'package:flutter/material.dart';

class OnlyGridPage extends StatefulWidget {
  @override
  _OnlyGridPageState createState() => _OnlyGridPageState();
}

class _OnlyGridPageState extends State<OnlyGridPage> {
  List<OnlyModel> onlyList = OnlyModel.list;
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return OnlyDetailPage(onlyList[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 100,
                                    child: Hero(
                                      tag: "hero${onlyList[index].imgPath}",
                                      child: Image(
                                        image: AssetImage(
                                            "images/${onlyList[index].imgPath}"),
                                      ),
                                    ),
                                  ),
                                ],
