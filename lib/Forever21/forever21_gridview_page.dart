...
import 'forever21_details_page.dart';
import 'forever21_listview_page.dart';
import 'package:flutter/material.dart';

class Forever21GridPage extends StatefulWidget {
  @override
  _Forever21GridPageState createState() => _Forever21GridPageState();
}

class _Forever21GridPageState extends State<Forever21GridPage> {
  List<Forever21Model> forever21List = Forever21Model.list;
              ...
              children: [
                Container(
                  ...
                  child: ListView.builder(
                    itemCount: forever21List.length,
                    scrollDirection: Axis.vertical,
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return Forever21DetailPage(forever21List[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 30,
                                    child: Hero(
                                      tag: "hero${forever21List[index].imgPath}",
                                      child: Image(
                                        image: AssetImage(
                                            "images/${forever21List[index].imgPath}"),
                                      ),
                                    ),
                                  ),
                                ],
...
Widget _buildBackground(int index, double width) {
  ...
  return ClipPath(
    ...
    child: Container(
      color: forever21List[index].color,
      width: width,
      child: Stack(
        children: <Widget>[
          Padding(
