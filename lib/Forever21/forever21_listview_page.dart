...
import 'forever21_gridview_page.dart';
import 'forever21_model.dart';
import 'package:flutter/material.dart';

class Forever21ListPage extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<Forever21ListPage> {
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      PageRouteBuilder(
                        ...
                        pageBuilder: (context, animation, animationTime) {
                          return Forever21DetailPage(data);
                        },
                      ),
                    );
                  },
