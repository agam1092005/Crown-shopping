...
import 'louisphilippe_listview_page.dart';
import 'louisphilippe_model.dart';
import 'louisphilippe_details_page.dart';
import 'package:flutter/material.dart';

class LPGridPage extends StatefulWidget {
  @override
  _LPGridPageState createState() => _LPGridPageState();
}

class _LPGridPageState extends State<LPGridPage> {
  List<LPModel> lpList = LPModel.list;
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return LPDetailPage(lpList[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 1,
                                    child: Hero(
                                      tag: "hero${lpList[index].imgPath}",
                                      child: Image(
                                        image: AssetImage(
                                            "images/${lpList[index].imgPath}"),
                                      ),
                                    ),
                                  ),
                                ],
