...
import 'zara_details_page.dart';
import 'zara_listview_page.dart';
import 'package:flutter/material.dart';

class ZaraGridPage extends StatefulWidget {
  @override
  _ZaraGridPageState createState() => _ZaraGridPageState();
}

class _ZaraGridPageState extends State<ZaraGridPage> {
  List<ZaraModel> zaraList = ZaraModel.list;
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (context, animation, animationTime) {
                                return ZaraDetailPage(zaraList[index]);
                              },
                            ),
                          );
                        },
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    right: 30,
                                    child: Hero(
                                      tag: "hero${zaraList[index].imgPath}",
                                      child: Image(
                                        image: AssetImage(
                                            "images/${zaraList[index].imgPath}"),
                                      ),
                                    ),
                                  ),
                                ],
